...
public class InfixInToSuffix {
    ...
    public static void main(String[] args) {
        ...
        String a = infixInToSuffix.toSuffix("3+2*(7-5)");//传入 一串 算数公式

        System.out.println("--------------------------");
        System.out.println("中缀表达式结果：");
        System.out.println(3+2*(7-5));

        System.out.println("--------------------------");
        System.out.println("后缀表达式：");
        System.out.println(a);
        System.out.println("后缀表达式结果：");
        System.out.println(infixInToSuffix.dealEquation(a));
    }
